const promiseo = require('../src/promiseo')
const context = { foo: 'bar' }

const generateAsyncFn = (data, timeout) => {
  return jest.fn(() => {
...
describe('promiseo', () => {
  ...
  it('should work with async function', async () => {
    ...
    const res = await promiseo(fn, context)
  ...
  it('should work with promise which returns object of promises', async () => {
    ...
    const res = await promiseo(asyncFn)
  ...
  it('should work when one of promises raizes error', async () => {
    ...
    const res = await promiseo(obj, context)
  ...
  it('should raize error when one of promises has error and context.error is undefigned', async () => {
    ...
    await expect(promiseo(obj)).rejects.toThrow('something bad happened')
  })
